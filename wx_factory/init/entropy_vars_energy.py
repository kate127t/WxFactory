...
def conservative_to_entropy(Q: NDArray, geom: Cartesian2D, param: Configuration) -> NDArray[numpy.float64]:
    ...
    Important: Here the total energy formulation is used. 0 dentotes total energy E here.
    Input: u_E - conservative variables in total energy notation
    Output: v_E - entropy variables in total energy notation
...
def entropy_to_conservative(V: NDArray, geom: Cartesian2D, param: Configuration) -> NDArray[numpy.float64]:
    ...
    Important: Here the total energy formulation is used. 0 dentotes total energy E here.
    Input: v_E - entropy variables in total energy notation
    Output: u_E - conservative variables in total energy notation
    """
...
def entropy_function(Q: NDArray,geom:Cartesian2D)-> NDArray[numpy.float64]:
    ...
    ρ, _, _, _ , _ , _, _ = conservative_to_prim(Q)
    s = entropy(Q,geom)
    return - ρ*s
